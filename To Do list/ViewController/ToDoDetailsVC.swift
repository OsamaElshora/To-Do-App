...
class TodoDetailsVC: UIViewController {
    ...
    @IBAction func deleteButtonClicked(_ sender: Any) {
        let confirmAlert = UIAlertController(title: "Alert", message: "This Task will be deleted!", preferredStyle: .alert)
        let confimAction = UIAlertAction(title: "Delete", style: .destructive) { alert in
            ...
            let alert = UIAlertController(title: "Done", message: "The Task has been Deleted Successfully", preferredStyle: .alert)
        ...
        confirmAlert.addAction(confimAction)
